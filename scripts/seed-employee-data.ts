...
import {Todo} from '../src/database/mongodb/models/todo.model';
import {Leave} from '../src/database/mongodb/models/leave.model';
import {Notification} from '../src/database/mongodb/models/notification.model';
import { LeaveStatusEnum, LeaveTypeEnum } from '../src/constants/constants';
...
async function seedEmployeeData() {
  try {
    // Connect to MongoDB
    await mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/tcc');
